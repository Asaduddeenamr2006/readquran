...
createApp({
  setup() {
    ...
    const showTafsir = ref(false);
     const selectedTafsir = ref('ar.qurtubi');
     ...
     const playCurrentAyah = () => {
         ...
         const handleEnded = () => {
           if (playMode.value === 'repeat') {
             // Repeat current ayah
             playCurrentAyah();
           } else if (playMode.value === 'continue' && currentPlayingAyahIndex < allAyahs.value.length - 1) {
